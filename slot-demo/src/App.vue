<template>
  <div class="app-container">
    ...
    <button @click="color = 'green'">改变 color的颜色值</button> <hr />
...
export default {
  ...
  directives: {
    ...
    // bind()方法的第一个形参是 固定写法，是原生DOM对象，是指令绑定的元素。这里指 h1、h5标签
    color: {

      // 当指令第一次被绑定到元素上的时候，会立即触发 bind函数,形参中的el 表示 当前指令所绑定到的那个 DOM对象
      bind(el,binding) { 
